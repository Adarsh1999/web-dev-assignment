The link tag is used to link favicon and css file
nav tag is used for the navbar which is aligned using flexbox
The navbar has a logo, which is a png and when clicked on it redirects to the home page, and the navbar has a sign-up button when clicked on it redirects to a sign-up form

...
pokemon.addEventListener("change", (e) => {
  if (e.target.value === "Charmander") {
    document.getElementById("optional-label").innerHTML =
      "Which Charmander attack you want to use?";
    document.getElementById("label-optional").innerHTML =
      "<div><input type='checkbox' name='optional' value='flamethrower'> Flamethrower </input><input type='checkbox' name='optional' value='ember'> Ember</input><div>";
    document
      .getElementsByName("optional")
      .forEach((item) => item.addEventListener("change", checkOptional));
  } 
  
  else if (e.target.value === "Squirtle") {
    document.getElementById("optional-label").innerHTML =
      "Which Squirtle attack you want to use?";
    document.getElementById("label-optional").innerHTML =
      "<div><input type='checkbox' name='optional' value='surf'> Surf </input><input type='checkbox' name='optional' value='bubble'> Bubble</input><div>";
    document
      .getElementsByName("optional")
      .forEach((item) => item.addEventListener("change", checkOptional));
  }
    ...
    document.getElementById("optional-label").innerHTML =
      "Which Bulbasaur attack you want to use?";
    document.getElementById("label-optional").innerHTML =
      "<div><input type='checkbox' name='optional' value='razorleaf'> Razorleaf </input><input type='checkbox' name='optional' value='winewhip'> Winewhip</input><div>";
    document
      .getElementsByName("optional")
      .forEach((item) => item.addEventListener("change", checkOptional));
  }
